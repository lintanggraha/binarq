...
Map<String, dynamic> buatSoal(
  ...
  String pertanyaan,
  List<String> pilihanTeks,
  String jawabanBenarId,
  String penjelasan,
) {
  return {
    "id": id,
    "metadata": {
      ...
      "xp_reward": 20,
      "konteks_islami": true,
      "tag_nilai_islam": ["adab_dan_akhlak"]
    },
    "content": {
...
void main() async {
  ...
  soal.add(buatSoal(
      ...
      ["Minum", "Makan", "Mulut", "Melihat"],
      "B",
      "Kata 'Makan' diawali dengan huruf m dan a, dibaca 'ma'."));
  soal.add(buatSoal(
      "BIN-K1-STS-002",
      1,
      "B. Indo",
      ...
      ["Garpu", "Gelas", "Guling", "Gula"],
      "B",
      "'Gelas' diawali suku kata ge."));
  soal.add(buatSoal(
      "BIN-K1-STS-003",
      1,
      "B. Indo",
      ...
      ["Mata", "Mulut", "Muka", "Mimi"],
      "B",
      "'Mulut' digunakan untuk makan dan diawali suku kata mu."));
  soal.add(buatSoal(
      "BIN-K1-STS-004",
      1,
      "B. Indo",
      ...
      ["Macan", "Merpati", "Monyet", "Musang"],
      "C",
      "Monyet adalah hewan ciptaan Allah yang jago memanjat."));
  soal.add(buatSoal(
      "BIN-K1-STS-005",
      1,
      "B. Indo",
      ...
      ["Ma", "Me", "Mi", "Mo"],
      "B",
      "Suku kata yang tepat adalah 'Me', menjadi 'Merah'."));
  soal.add(buatSoal(
      "BIN-K1-STS-006",
      1,
      "B. Indo",
      ...
      ["Ma", "Me", "Mi", "Mo"],
      "C",
      "Kata 'Minyak' diawali suku kata mi."));
  ...
  soal.add(buatSoal(
      ...
      ["Tidur", "Mandi atau Wudhu", "Makan", "Bermain"],
      "B",
      "Kebersihan adalah sebagian dari iman. Kita harus wudhu sebelum shalat."));
  soal.add(buatSoal(
      "BIN-K1-STS-008",
      1,
      "B. Indo",
      ...
      ["Sabun", "Sikat gigi dan pasta", "Sampo", "Sisir"],
      "B",
      "Sikat gigi membuat mulut kita wangi dan bersih."));
  soal.add(buatSoal(
      "BIN-K1-STS-009",
      1,
      "B. Indo",
      ...
      ["Sabun cuci", "Odol", "Sampo", "Minyak goreng"],
      "C",
      "Sampo digunakan khusus untuk membersihkan rambut."));
  soal.add(buatSoal(
      "BIN-K1-STS-010",
      1,
      "B. Indo",
      ...
      [
        "Dibiarkan saja",
        "Menyuruh teman membuangnya",
        "Membuangnya ke tempat sampah",
        "Ditendang"
      ],
      "C",
      "Membuang sampah pada tempatnya dapat pahala lho."));
  soal.add(buatSoal(
      "BIN-K1-STS-011",
      1,
      "B. Indo",
      ...
      ["Kekayaan", "Kesehatan", "Kepandaian", "Kemalasan"],
      "B",
      "Orang yang bersih akan dijauhkan dari penyakit."));
  soal.add(buatSoal(
      "BIN-K1-STS-012",
      1,
      "B. Indo",
      ...
      ["Kotor", "Berantakan", "Bersih", "Harum"],
      "C",
      "Menyapu membersihkan debu di lantai."));
  soal.add(buatSoal(
      "BIN-K1-STS-013",
      1,
      "B. Indo",
      ...
      ["Senin", "Jumat", "Ahad", "Kamis"],
      "B",
      "Sunnah Nabi Muhammad adalah memotong kuku di hari Jumat."));
  ...
  soal.add(buatSoal(
      ...
      [
        ...
        "Tolong buang sampah ini ke tong sampah!",
        "Saya suka makan apel.",
        "Kemarin hari Minggu."
      ],
      "B",
      "Kalimat perintah biasanya berakhiran tanda seru (!) dan menyuruh melakukan sesuatu."));
  soal.add(buatSoal(
      "BIN-K1-STS-015",
      1,
      "B. Indo",
      ...
      ["Kalimat pujian", "Kalimat tanya", "Kalimat larangan", "Kalimat cerita"],
      "C",
      "Kalimat larangan biasanya menggunakan kata 'Jangan'."));
  soal.add(buatSoal(
      "BIN-K1-STS-016",
      1,
      "B. Indo",
      ...
      ["Mari", "Ayo", "Jangan", "Tolong"],
      "C",
      "'Jangan' digunakan untuk melarang."));
  soal.add(buatSoal(
      "BIN-K1-STS-017",
      1,
      "B. Indo",
      ...
      "D",
      "Tanda seru (!) menandakan penekanan perintah."));
  soal.add(buatSoal(
      "BIN-K1-STS-018",
      1,
      "B. Indo",
      ...
      ["Pujian", "Larangan", "Tanya", "Ajakan"],
      "B",
      "Karena ada kata 'Jangan', maka itu kalimat larangan."));
  ...
  soal.add(buatSoal(
      ...
      ["Gagak", "Gajah", "Garuda", "Gurita"],
      "B",
      "Gajah ciptaan Allah yang sangat besar."));
  soal.add(buatSoal(
      "BIN-K1-STS-020",
      1,
      "B. Indo",
      ...
      ["Gigi", "Gusi", "Garam", "Gula"],
      "A",
      "'Gigi' diawali dengan suku kata 'gi'."));
  soal.add(buatSoal(
      "BIN-K1-STS-021",
      1,
      "B. Indo",
      ...
      ["Jauhi", "Bohongi", "Hormati", "Lupakan"],
      "C",
      "Menghormati guru adalah adab santri yang baik."));
  soal.add(buatSoal(
      "BIN-K1-STS-022",
      1,
      "B. Indo",
      ...
      ["Ga", "Gi", "Gu", "Ge"],
      "C",
      "Suku kata yang tepat adalah 'Gu', menjadi kata 'Gula'."));
  soal.add(buatSoal(
      "BIN-K1-STS-023",
      1,
      "B. Indo",
      ...
      ["Mengejek", "Menyayangi", "Bermusuhan", "Diam-diaman"],
      "B",
      "Allah menciptakan manusia berbeda-beda agar saling mengenal dan menyayangi."));
  soal.add(buatSoal(
      "BIN-K1-STS-024",
      1,
      "B. Indo",
      ...
      [
        "Berebut makanan",
        "Menghina makanan teman",
        "Saling menghargai",
        "Membuang makanan"
      ],
      "C",
      "Perbedaan kesukaan itu biasa, kita harus menghargainya."));
  soal.add(buatSoal(
      "BIN-K1-STS-025",
      1,
      "B. Indo",
      ...
      "C",
      "Susunan yang benar adalah: Ali pergi ke masjid."));
